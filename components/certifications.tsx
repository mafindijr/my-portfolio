...
const CERTIFICATIONS = [
  ...
  },
  {
    ...
    issuer: "Udacity",
    date: "2023",
    description: "Mastered modern web development with React, Node.js, and databases",
  },
  {
    title: "Web3 Developer Bootcamp",
    issuer: "Alchemy University",
    date: "2023",
    description: "Intensive training in blockchain development and DeFi protocols",
  },
]
...
const ACHIEVEMENTS = [
  {
    ...
    description: "Contributed to 15+ open-source projects including major blockchain libraries",
  },
  {
  ...
  },
  {
    ...
    description: "Won Best Developer Award at BlockChain Conference 2024",
  },
  {
    title: "Mentor",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl">
            Recognition of my expertise and contributions in web development and blockchain technology
          </p>
        </div>
